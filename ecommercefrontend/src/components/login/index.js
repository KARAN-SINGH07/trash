                    ...
                    <div class="card card-registration my-4">
                        <div class="row g-0">
                            <div class="col-xl-6 d-none d-xl-block">
                                        {/* <img src="img/registration.jpg" alt="Sample
                                                photo" class="img-fluid" style="border-top-left-radius: .25rem;" /> */}
                                        
                            </div>
                            <div class="col-xl-6">
                                <div class="card-body p-md-5 text-black">
                                    <h3 class="mb-5 text-uppercase
                                            text-success">Login form</h3>
                                    ...
                                    <div class="d-flex flex-row
                                        ...
                                        <button type="button" class="btn
                                                btn-outline-primary btn-floating mx-1">
                                        ...
                                        <button type="button" class="btn
                                                btn-outline-info btn-floating mx-1">
                                    ...
                                    <div class="col-md-12">
                                        <select class="form-select mt-3" required>
                                              ...
                                              <option value="jweb">Admin</option>
                                              <option value="sweb">User</option>
                                    ...
                                    <div class="form-outline mb-4 mt-4">
                                        <input type="text" id="form3Example97" class="form-control
                                                    form-control-lg" placeholder="Enter your e-mail" />
                                        <label class="form-label" for="form3Example97">Email
                                                    ID</label>
                                    </div>
                                    <div class="form-outline mb-4">
                                        <input type="text" id="form3Example97" class="form-control
                                                    form-control-lg" placeholder="Enter your password" />
                                    ...
                                    <div class="d-flex
                                        ...
                                        <div class="form-check mb-0">
                                            <input class="form-check-input
                                                        me-2" type="checkbox" value="" id="form2Example3" />
                                            <label class="form-check-label" for="form2Example3">
                                                        Remember me
                                                    </label>
                                        </div>
                                        <a href="forgetpassword.html" class="text-body">Forgot
                                                    password?</a>
                                    </div>
                                    ...
                                    <div class="text-center
                                        ...
                                        <p class="small fw-bold mt-2
                                                    pt-1 mb-0">Don't have an account? <a href="registrationform.html" class="link-danger">Register</a></p>
                                    </div>
